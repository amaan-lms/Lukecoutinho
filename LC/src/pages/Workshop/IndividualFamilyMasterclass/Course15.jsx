...
import { 
  ...
  ArrowRight, Brain, Heart, Activity, Sparkles, CheckCircle2
} from 'lucide-react';
import img from '../../../assets/14.jpg'; 

const TraumaHealingCourseView = () => {
  const [isHovered, setIsHovered] = useState(false);

  const courseStats = [
    { icon: <Users size={18} />, label: "17 Students Enrolled", detail: "Emotional healing course" },
  ...
  const learningObjectives = [
    { 
      ...
      desc: "Learn how suppressed and repressed emotions shape thoughts, behaviors, and health." 
    },
    { 
      icon: <Heart />, 
      title: "Mind–Body Impact", 
      desc: "Explore how emotional wounds can influence mental well-being and physical symptoms." 
    },
    { 
      icon: <Activity />, 
      title: "Healing Strategies", 
      desc: "Use practical tools to safely process emotions and build emotional resilience." 
    },
    { 
      icon: <Sparkles />, 
      title: "Reconnecting with Yourself", 
      desc: "Discover ways to restore inner balance, self-awareness, and healthier relationships." 
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 h-full flex flex-col justify-end pb-12">
          <motion.div initial={{ y: 30, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="space-y-4">
            ...
            <h1 className="text-5xl md:text-7xl font-black text-white tracking-tighter max-w-5xl leading-[0.9]">
              Overcoming Trauma & Repressed Emotions <br/>
              <span className="text-orange-500 italic font-light">Healing from Within</span>
            </h1>
          </motion.div>
        </div>
      </section>
        ...
        <div className="lg:col-span-8 space-y-16">
          ...
          <section className="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm">
            <h2 className="text-2xl font-bold mb-6 text-slate-800 flex items-center gap-3">
              <Heart className="text-orange-500" /> Healing the Wounds You Can’t See
            </h2>
            <p className="text-slate-500 leading-relaxed text-lg italic">
              Unprocessed trauma and buried emotions can quietly affect your health, mood, and relationships. 
              This course guides you through understanding emotional patterns and provides safe, practical 
              tools to release, heal, and reconnect with your authentic self.
            </p>
          </section>
          ...
          <section className="bg-slate-900 p-12 rounded-[3rem] text-white overflow-hidden relative shadow-2xl">
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                {[
                  "Individuals healing from past trauma or emotional wounds",
                  "Those dealing with chronic stress, anxiety, or emotional numbness",
                  "People seeking better relationships through emotional awareness",
                  "Anyone wanting to reconnect with their inner self and build resilience"
                ].map((text, i) => (
          ...
          <section className="bg-white border border-slate-100 rounded-[2.5rem] overflow-hidden">
            <div className="p-10 space-y-6">
              ...
              <div className="space-y-3">
                <p className="text-sm text-slate-500 flex gap-2"><CheckCircle2 size={16} className="text-orange-500" /> No prior mental health knowledge required</p>
                <p className="text-sm text-slate-500 flex gap-2"><CheckCircle2 size={16} className="text-orange-500" /> Fully online and self-paced</p>
                <p className="text-sm text-slate-500 flex gap-2"><CheckCircle2 size={16} className="text-orange-500" /> Includes reflection and emotional awareness exercises</p>
              </div>
              <p className="text-slate-400 text-[11px] leading-relaxed pt-6 border-t border-slate-50 italic">
                Educational use only. Not a substitute for professional medical or psychological advice.
              </p>
            </div>
          </section>
        </div>
...
export default TraumaHealingCourseView;
