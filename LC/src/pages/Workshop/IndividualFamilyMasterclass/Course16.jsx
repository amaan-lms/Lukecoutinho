...
const AnxietyCourseView = () => {
  const [isHovered, setIsHovered] = useState(false);

  const courseStats = [
    { icon: <Users size={18} />, label: "41 Students Enrolled", detail: "Anxiety management course" },
    { icon: <Clock size={18} />, label: "Self-Paced Learning", detail: "Lifetime access" },
  ...
  const learningObjectives = [
    { 
      ...
      desc: "Learn why anxiety is a natural survival response and how it affects your body and mind." 
    },
    { 
      icon: <Heart />, 
      title: "Lifestyle & Nervous System", 
      desc: "See how sleep, food, breath, and daily habits influence emotional balance." 
    },
    { 
      icon: <Activity />, 
      title: "Daily Coping Tools", 
      desc: "Use breathing, grounding, and visualization techniques to manage anxiety in real life." 
    },
    { 
      icon: <Sparkles />, 
      title: "Build Emotional Resilience", 
      desc: "Shift thought patterns, reduce overwhelm, and respond to stress with confidence." 
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 h-full flex flex-col justify-end pb-12">
          <motion.div initial={{ y: 30, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="space-y-4">
            ...
            <h1 className="text-5xl md:text-7xl font-black text-white tracking-tighter max-w-5xl leading-[0.9]">
              Anxiety Survival Guide <br/>
              <span className="text-orange-500 italic font-light">Calm, Clarity & Control</span>
            </h1>
          </motion.div>
        </div>
      </section>
        ...
        <div className="lg:col-span-8 space-y-16">
          ...
          <section className="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm">
            <h2 className="text-2xl font-bold mb-6 text-slate-800 flex items-center gap-3">
              <Heart className="text-orange-500" /> Practical Help for Everyday Anxiety
            </h2>
            <p className="text-slate-500 leading-relaxed text-lg italic">
              Anxiety can show up as racing thoughts, poor sleep, irritability, or constant worry. 
              This course helps you understand anxiety as a natural body response and teaches 
              simple, proven lifestyle tools to calm your mind and regain emotional balance.
            </p>
          </section>
          ...
          <section className="bg-slate-900 p-12 rounded-[3rem] text-white overflow-hidden relative shadow-2xl">
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                {[
                  "People dealing with daily anxiety, stress, or overthinking",
                  "Professionals, students, and parents under pressure",
                  "Anyone seeking natural, lifestyle-based anxiety support",
                  "Individuals wanting better emotional balance and resilience"
                ].map((text, i) => (
          ...
          <section className="bg-white border border-slate-100 rounded-[2.5rem] overflow-hidden">
            <div className="p-10 space-y-6">
              ...
              <div className="space-y-3">
                <p className="text-sm text-slate-500 flex gap-2"><CheckCircle2 size={16} className="text-orange-500" /> No prior knowledge required</p>
                ...
                <p className="text-sm text-slate-500 flex gap-2"><CheckCircle2 size={16} className="text-orange-500" /> Includes practical exercises and reflections</p>
              </div>
...
export default AnxietyCourseView;
