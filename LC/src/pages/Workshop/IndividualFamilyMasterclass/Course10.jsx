...
import { 
  ...
  ArrowRight, Brain, Sparkles, Moon, 
  Heart, CheckCircle2, Activity
} from 'lucide-react';
import img from '../../../assets/9th.jpg'; 

const MentalVitaminsCourseView = () => {
  const [isHovered, setIsHovered] = useState(false);

  const courseStats = [
    { icon: <Users size={18} />, label: "23 Students Enrolled", detail: "Growing community" },
    { icon: <Clock size={18} />, label: "45–75 Minutes", detail: "Self-paced learning" },
    { icon: <Calendar size={18} />, label: "Online Access", detail: "Learn anytime" }
  ];
  ...
  const learningObjectives = [
    { 
      ...
      desc: "Learn how quiet moments reduce stress and improve clarity." 
    },
    { 
      icon: <Sparkles />, 
      title: "Power of Intention", 
      desc: "Use focused intentions to guide actions and daily energy." 
    },
    { 
      icon: <Brain />, 
      title: "Mindful Practices", 
      desc: "Simple exercises to build focus, calm, and awareness." 
    },
    { 
      icon: <Heart />, 
      title: "Emotional & Physical Balance", 
      desc: "Support emotional healing and overall well-being." 
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 h-full flex flex-col justify-end pb-12">
          <motion.div initial={{ y: 30, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="space-y-4">
            ...
            <h1 className="text-5xl md:text-7xl font-black text-white tracking-tighter max-w-5xl leading-[0.9]">
              Mental Vitamins <br/>
              <span className="text-orange-500 italic font-light">Silence & Intention</span>
            </h1>
          </motion.div>
        </div>
      </section>
        ...
        <div className="lg:col-span-8 space-y-16">
          ...
          <section className="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm">
            <h2 className="text-2xl font-bold mb-6 text-slate-800 flex items-center gap-3">
              <Activity className="text-orange-500" /> Calm the Mind. Strengthen the Self.
            </h2>
            <p className="text-slate-500 leading-relaxed text-lg italic">
              Discover how silence and intentional living can transform your emotional, 
              physical, and mental well-being. Learn simple practices to reduce stress, 
              improve focus, and build inner balance in everyday life.
            </p>
          </section>
          ...
          <section className="bg-slate-900 p-12 rounded-[3rem] text-white overflow-hidden relative shadow-2xl">
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                {[
                  "People feeling stressed or mentally overwhelmed",
                  "Anyone seeking calm, clarity, and better focus",
                  "Individuals exploring mindfulness and self-growth",
                  "Those wanting emotional balance and inner peace"
                ].map((text, i) => (
            ...
            <Brain className="absolute -bottom-10 -right-10 text-white opacity-5 w-64 h-64" />
          </section>
          ...
          <section className="bg-white border border-slate-100 rounded-[2.5rem] overflow-hidden">
            <div className="p-10 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-slate-500 flex gap-2"><CheckCircle2 size={16} className="text-orange-500" /> Simple, practical techniques</p>
              </div>
              <p className="text-slate-400 text-[11px] leading-relaxed pt-6 border-t border-slate-50 italic">
                Educational use only. Not a substitute for professional medical or mental health advice.
              </p>
            </div>
          </section>
        </div>
...
export default MentalVitaminsCourseView;
