...
import { 
  ...
  ArrowRight, Activity, Microscope, Flame, 
  Stethoscope, HeartPulse, Sparkles, CheckCircle2
} from 'lucide-react';
import img from '../../../assets/6th.webp'; 

const InflammationCodeView = () => {
  const [isHovered, setIsHovered] = useState(false);

  // Data extracted from
  const courseStats = [
    { icon: <Users size={18} />, label: "247 Students enrolled", detail: "Popular module" },
    { icon: <Clock size={18} />, label: "45-75 Minutes", detail: "Self-paced learning" },
  ...
  const learningObjectives = [
    { 
      icon: <Microscope />, 
      title: "Biological Mechanics", 
      desc: "Understand the ins and outs of inflammation, from acute responses to chronic pathways." 
    },
    { 
      icon: <Flame />, 
      title: "Disease Connections", 
      desc: "Explore the pivotal role of inflammation in developing chronic diseases like diabetes and heart disease." 
    },
    { 
      icon: <Activity />, 
      title: "Actionable Strategies", 
      desc: "Learn practical methods to integrate anti-inflammatory practices seamlessly into your daily routine." 
    },
    { 
      icon: <Sparkles />, 
      title: "Vibrant Longevity", 
      desc: "Utilize dietary interventions and lifestyle modifications for long-lasting wellness benefits." 
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 h-full flex flex-col justify-end pb-12">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-black text-white tracking-tighter max-w-5xl leading-[0.9]">
              The Inflammation Code: <br/>
              <span className="text-orange-500 italic font-light">The Root Cause</span> of Chronic Disease
            </h1>
          </motion.div>
        </div>
      </section>
        ...
        <div className="lg:col-span-8 space-y-16">
          ...
          <section className="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm">
            <h2 className="text-2xl font-bold mb-6 text-slate-800 flex items-center gap-3">
              <HeartPulse className="text-orange-500" /> Fight Back Head-On
            </h2>
            <p className="text-slate-500 leading-relaxed text-lg italic">
              "Do you feel like your health is out of control, grappling with chronic conditions or nagging symptoms that won't go away? 
              By delving into the science of inflammation, you can take charge of your well-being and pave the way for a healthier, more vibrant life."
            </p>
          </section>
          ...
          <section className="bg-slate-900 p-12 rounded-[3rem] text-white overflow-hidden relative shadow-2xl">
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                {[
                  "Individuals dealing with chronic illness seeking holistic approaches",
                  "Health enthusiasts looking to deepen their understanding of inflammation",
                  "Anyone committed to taking proactive steps toward a vibrant life",
                  "Those looking to refine their wellness strategies with evidence-based approaches"
                ].map((text, i) => (
          ...
          <section className="bg-white border border-slate-100 rounded-[2.5rem] overflow-hidden">
            <div className="p-10 space-y-6">
              ...
              <div className="space-y-3">
                <p className="text-sm text-slate-500 flex gap-2"><CheckCircle2 size={16} className="text-orange-500" /> No prior knowledge of inflammation or health science is required.</p>
                <p className="text-sm text-slate-500 flex gap-2"><CheckCircle2 size={16} className="text-orange-500" /> Pre-recorded online courses that can be taken at your convenience.</p>
                <p className="text-sm text-slate-500 flex gap-2"><CheckCircle2 size={16} className="text-orange-500" /> Completion time ranges from 45 to 75 minutes.</p>
              </div>
...
export default InflammationCodeView;