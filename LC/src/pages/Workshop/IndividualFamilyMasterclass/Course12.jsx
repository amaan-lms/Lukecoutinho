...
const ForgivenessCourseView = () => {
  const [isHovered, setIsHovered] = useState(false);

  const courseStats = [
    { icon: <Users size={18} />, label: "13 Students Enrolled", detail: "Emotional wellness course" },
  ...
  const learningObjectives = [
    { 
      ...
      desc: "Learn what forgiveness truly means and how it brings emotional freedom." 
    },
    { 
      icon: <Brain />, 
      title: "Healing Emotional Pain", 
      desc: "Process hurt, betrayal, and difficult memories in healthy ways." 
    },
    { 
      icon: <Handshake />, 
      title: "Rebuilding Trust", 
      desc: "Find tools to restore trust and improve relationships after conflict." 
    },
    { 
      icon: <Sparkles />, 
      title: "Inner Peace & Resilience", 
      desc: "Develop mindfulness and emotional strength for lasting peace." 
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 h-full flex flex-col justify-end pb-12">
          <motion.div initial={{ y: 30, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="space-y-4">
            ...
            <h1 className="text-5xl md:text-7xl font-black text-white tracking-tighter max-w-5xl leading-[0.9]">
              Luke’s Guide to Forgiveness <br/>
              <span className="text-orange-500 italic font-light">For Teens & Adults</span>
            </h1>
          </motion.div>
        </div>
      </section>
        ...
        <div className="lg:col-span-8 space-y-16">
          ...
          <section className="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm">
            <h2 className="text-2xl font-bold mb-6 text-slate-800 flex items-center gap-3">
              <Heart className="text-orange-500" /> Heal, Let Go, and Move Forward
            </h2>
            <p className="text-slate-500 leading-relaxed text-lg italic">
              Forgiveness helps release emotional pain and resentment. This course offers practical 
              tools to heal from hurt, rebuild trust, and create a more peaceful and emotionally balanced life.
            </p>
          </section>
          ...
          <section className="bg-slate-900 p-12 rounded-[3rem] text-white overflow-hidden relative shadow-2xl">
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                {[
                  "Teens and adults healing from emotional hurt",
                  "Those recovering from betrayal or broken trust",
                  "Individuals affected by bullying or conflict",
                  "Anyone seeking inner peace and emotional strength"
                ].map((text, i) => (
          ...
          <section className="bg-white border border-slate-100 rounded-[2.5rem] overflow-hidden">
            <div className="p-10 space-y-6">
              ...
              <div className="space-y-3">
                <p className="text-sm text-slate-500 flex gap-2"><CheckCircle2 size={16} className="text-orange-500" /> No prior psychology knowledge required</p>
                ...
                <p className="text-sm text-slate-500 flex gap-2"><CheckCircle2 size={16} className="text-orange-500" /> Practical emotional healing exercises</p>
              </div>
              <p className="text-slate-400 text-[11px] leading-relaxed pt-6 border-t border-slate-50 italic">
                Educational use only. Not a substitute for professional psychological or medical advice.
              </p>
            </div>
          </section>
        </div>
...
export default ForgivenessCourseView;
