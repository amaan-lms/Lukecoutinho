...
import { 
  ...
  ArrowRight, Activity, HeartHandshake, Brain, 
  MessageCircle, Sparkles, CheckCircle2
} from 'lucide-react';
import img from '../../../assets/8th.jpg'; 

const LifeLessonsCourseView = () => {
  const [isHovered, setIsHovered] = useState(false);

  const courseStats = [
    { icon: <Users size={18} />, label: "5 Students Enrolled", detail: "Growing community" },
    { icon: <Clock size={18} />, label: "45–75 Minutes", detail: "Flexible learning" },
  ...
  const learningObjectives = [
    { 
      icon: <Brain />, 
      title: "Mind & Emotions", 
      desc: "Understand how thoughts and emotions shape decisions and relationships." 
    },
    { 
      icon: <HeartHandshake />, 
      title: "Healthy Relationships", 
      desc: "Build strong, respectful connections through awareness and communication." 
    },
    { 
      icon: <MessageCircle />, 
      title: "Communication Skills", 
      desc: "Handle difficult conversations with clarity, empathy, and confidence." 
    },
    { 
      icon: <Sparkles />, 
      title: "Personal Growth", 
      desc: "Create habits that support resilience, balance, and long-term well-being." 
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 h-full flex flex-col justify-end pb-12">
          <motion.div initial={{ y: 30, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="space-y-4">
            ...
            <h1 className="text-5xl md:text-7xl font-black text-white tracking-tighter max-w-5xl leading-[0.9]">
              Life Lessons <br/>
              <span className="text-orange-500 italic font-light">for Adults</span>
            </h1>
          </motion.div>
        </div>
      </section>
        ...
        <div className="lg:col-span-8 space-y-16">
          ...
          <section className="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm">
            <h2 className="text-2xl font-bold mb-6 text-slate-800 flex items-center gap-3">
              <Activity className="text-orange-500" /> Real-World Skills for Adult Life
            </h2>
            <p className="text-slate-500 leading-relaxed text-lg italic">
              Navigate relationships, emotional health, and major life decisions with clarity. 
              This course gives you practical tools to build resilience, communicate better, 
              and create balanced, fulfilling relationships.
            </p>
          </section>
          ...
          <section className="bg-slate-900 p-12 rounded-[3rem] text-white overflow-hidden relative shadow-2xl">
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                {[
                  "Adults seeking healthier relationships",
                  "People preparing for marriage or long-term commitment",
                  "Individuals focused on emotional growth",
                  "Anyone wanting better life decisions and balance"
                ].map((text, i) => (
          ...
          <section className="bg-white border border-slate-100 rounded-[2.5rem] overflow-hidden">
            <div className="p-10 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-slate-500 flex gap-2"><CheckCircle2 size={16} className="text-orange-500" /> Short, practical lessons</p>
              </div>
...
export default LifeLessonsCourseView;
