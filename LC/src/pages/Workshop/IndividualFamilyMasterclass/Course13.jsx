...
import { 
  ...
  ArrowRight, Apple, Brain, Activity, Sparkles, 
  CheckCircle2
} from 'lucide-react';
import img from '../../../assets/12.jpeg'; 

const ChildrenWellnessCourseView = () => {
  const [isHovered, setIsHovered] = useState(false);

  const courseStats = [
    { icon: <Users size={18} />, label: "222 Students Enrolled", detail: "Family wellness course" },
  ...
  const learningObjectives = [
    { 
      icon: <Apple />, 
      title: "Cellular Nutrition Basics", 
      desc: "Learn the essential nutrients that support growing bodies and strong immunity." 
    },
    { 
      icon: <Activity />, 
      title: "Healthy Daily Habits", 
      desc: "Discover simple routines that improve energy, focus, and overall wellness." 
    },
    { 
      icon: <Brain />, 
      title: "Emotional & Mental Well-being", 
      desc: "Understand how feelings, stress, and mindset impact physical health." 
    },
    { 
      icon: <Sparkles />, 
      title: "Holistic Lifestyle Pillars", 
      desc: "Explore sleep, movement, nutrition, and connection for lifelong balance." 
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 h-full flex flex-col justify-end pb-12">
          <motion.div initial={{ y: 30, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="space-y-4">
            ...
            <h1 className="text-5xl md:text-7xl font-black text-white tracking-tighter max-w-5xl leading-[0.9]">
              Children’s Wellness 101 <br/>
              <span className="text-orange-500 italic font-light">Smart Choices & Holistic Health</span>
            </h1>
          </motion.div>
        </div>
      </section>
        ...
        <div className="lg:col-span-8 space-y-16">
          ...
          <section className="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm">
            <h2 className="text-2xl font-bold mb-6 text-slate-800 flex items-center gap-3">
              <Apple className="text-orange-500" /> Building Healthy Foundations Early
            </h2>
            <p className="text-slate-500 leading-relaxed text-lg italic">
              This course empowers parents, teens, and families with simple, practical tools to 
              build lifelong wellness. Learn how nutrition, daily habits, and emotional balance 
              shape a child’s growth, energy, and resilience.
            </p>
          </section>
          ...
          <section className="bg-slate-900 p-12 rounded-[3rem] text-white overflow-hidden relative shadow-2xl">
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                {[
                  "Parents who want to support their child’s long-term health",
                  "Teens learning to build strong daily wellness habits",
                  "Families aiming to live a healthier lifestyle together",
                  "Caregivers and educators promoting holistic well-being"
                ].map((text, i) => (
          ...
          <section className="bg-white border border-slate-100 rounded-[2.5rem] overflow-hidden">
            <div className="p-10 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-slate-500 flex gap-2"><CheckCircle2 size={16} className="text-orange-500" /> Practical, family-friendly guidance</p>
              </div>
...
export default ChildrenWellnessCourseView;
