...
import { 
  ...
  ArrowRight, ShieldPlus, Droplets, Leaf, 
  Stethoscope, Microscope, LayoutGrid, CheckCircle2
} from 'lucide-react';
import img from '../../../assets/8th.jpg'; 
...
const LymphaticResetView = () => {
  ...
  const courseStats = [
    { icon: <Users size={18} />, label: "125 Students enrolled", detail: "Active learners" },
    { icon: <Clock size={18} />, label: "60-90 Minutes", detail: "Comprehensive guide" },
  ...
  const curriculumHighlights = [
    { 
      ...
      desc: "Gain a clear understanding of how the lymphatic system supports immunity, filtration, and overall health." 
    },
    { 
      icon: <ShieldPlus />, 
    ...
    { 
      ...
      desc: "Learn how factors like movement, nutrition, hydration, and stress impact lymphatic function." 
    },
    { 
      icon: <Droplets />, 
      title: "Detox & Glow", 
      desc: "Explore the role of lymphatic drainage in reducing toxin buildup and promoting a natural glow." 
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 h-full flex flex-col justify-end pb-12">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-black text-white tracking-tighter max-w-5xl leading-[0.9]">
              ...
              <span className="text-orange-500 italic font-light">A Holistic Approach</span> to Immunity & Detox
            </h1>
          </motion.div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-8 space-y-16">
          ...
          <section className="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm">
            <h2 className="text-2xl font-bold mb-6 text-slate-800 flex items-center gap-3">
              <Leaf className="text-orange-500" /> Cleanse Your Body's Filter
            </h2>
            <p className="text-slate-500 leading-relaxed text-lg italic">
              "Often overlooked, the lymphatic system is a silent workhorse responsible for filtration, immune defense, and fluid balance. 
              This course will empower you with the science and practice behind lymphatic drainage, a vital process that keeps your system flowing and detoxified."
            </p>
          </section>
          ...
          <section className="bg-slate-900 p-12 rounded-[3rem] text-white overflow-hidden relative shadow-2xl">
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                {[
                  "Those experiencing sluggish lymphatic function (bloating, fatigue)",
                  "Individuals with a history of cancer, lymphedema, or low immunity",
                  "Wellness enthusiasts seeking natural ways to support body cleansing",
                  "Anyone curious about optimizing the body's self-cleansing mechanisms"
                ].map((text, i) => (
            ...
            <Stethoscope className="absolute -bottom-10 -right-10 text-white opacity-5 w-64 h-64" />
          </section>
          ...
          <section className="bg-white border border-slate-100 rounded-[2.5rem] overflow-hidden">
            <div className="p-10 space-y-6">
              ...
              <div className="space-y-3">
                <p className="text-sm text-slate-500 flex gap-2"><CheckCircle2 size={16} className="text-orange-500" /> No prior knowledge of the lymphatic system or drainage techniques is required.</p>
                <p className="text-sm text-slate-500 flex gap-2"><CheckCircle2 size={16} className="text-orange-500" /> Open to all age groups of 14 and above.</p>
                <p className="text-sm text-slate-500 flex gap-2"><CheckCircle2 size={16} className="text-orange-500" /> The course duration ranges from 60 to 90 minutes.</p>
              </div>
        ...
        <aside className="lg:col-span-4 sticky top-12">
          ...
          >
            ...
            <div className="mt-8 flex flex-col items-center gap-3 opacity-40 text-center">
              <div className="flex items-center gap-2">
                <ShieldCheck size={14} className="text-slate-900" />
                <span className="text-[10px] font-black uppercase tracking-widest leading-none">Safe & Secure checkout</span>
              </div>
            </div>
          </motion.div>
        </aside>
