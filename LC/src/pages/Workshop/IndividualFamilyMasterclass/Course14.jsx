...
import { 
  ...
  ArrowRight, Brain, Activity, HeartPulse, Sparkles, CheckCircle2
} from 'lucide-react';
import img from '../../../assets/13.jpg'; 

const IllnessAnxietyCourseView = () => {
  const [isHovered, setIsHovered] = useState(false);

  const courseStats = [
    { icon: <Users size={18} />, label: "18 Students Enrolled", detail: "Mental wellness course" },
  ...
  const learningObjectives = [
    { 
      icon: <Brain />, 
      title: "Understanding IAD", 
      desc: "Learn what Illness Anxiety Disorder is and how it affects thoughts and behavior." 
    },
    { 
      icon: <HeartPulse />, 
      title: "Mind–Body Connection", 
      desc: "Discover how anxiety can create real physical sensations and symptoms." 
    },
    { 
      icon: <Activity />, 
      title: "Breaking the Fear Cycle", 
      desc: "Build tools to reduce compulsive checking, reassurance seeking, and panic." 
    },
    { 
      icon: <Sparkles />, 
      title: "Recovery Strategies", 
      desc: "Use practical reflection exercises and daily habits to regain calm and control." 
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 h-full flex flex-col justify-end pb-12">
          <motion.div initial={{ y: 30, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="space-y-4">
            ...
            <h1 className="text-5xl md:text-7xl font-black text-white tracking-tighter max-w-5xl leading-[0.9]">
              Conquering Illness Anxiety <br/>
              <span className="text-orange-500 italic font-light">From Fear to Freedom</span>
            </h1>
          </motion.div>
        </div>
      </section>
        ...
        <div className="lg:col-span-8 space-y-16">
          ...
          <section className="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm">
            <h2 className="text-2xl font-bold mb-6 text-slate-800 flex items-center gap-3">
              <Brain className="text-orange-500" /> Break Free from Constant Health Worry
            </h2>
            <p className="text-slate-500 leading-relaxed text-lg italic">
              If health fears dominate your thoughts, this course helps you understand why it happens 
              and how to regain control. Learn practical, science-backed strategies to calm anxiety, 
              reduce compulsive symptom checking, and restore peace of mind.
            </p>
          </section>
          ...
          <section className="bg-slate-900 p-12 rounded-[3rem] text-white overflow-hidden relative shadow-2xl">
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                {[
                  "People struggling with constant health worries",
                  "Those diagnosed with IAD or hypochondria",
                  "Individuals with anxiety linked to OCD tendencies",
                  "Anyone wanting to understand the mind–body connection"
                ].map((text, i) => (
          ...
          <section className="bg-white border border-slate-100 rounded-[2.5rem] overflow-hidden">
            <div className="p-10 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-slate-500 flex gap-2"><CheckCircle2 size={16} className="text-orange-500" /> Includes reflection exercises and practical tools</p>
              </div>
...
export default IllnessAnxietyCourseView;
